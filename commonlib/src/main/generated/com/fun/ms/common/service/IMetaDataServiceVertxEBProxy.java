...
public class IMetaDataServiceVertxEBProxy implements IMetaDataService {
  ...
  public IMetaDataServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public IMetaDataServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void process(MetaDataRequest request, Handler<AsyncResult<MetaDataResponse>> resultHandler) {
    ...
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        ...
        resultHandler.handle(Future.succeededFuture(res.result().body() == null ? null : new MetaDataResponse(res.result().body())));
                      }
    });
  }
